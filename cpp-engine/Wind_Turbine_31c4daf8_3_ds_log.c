  ...
  NeDynamicSystemInput *t3, NeDsMethodOutput *t4)
{
  ...
  t0[8ULL] = Hydraulic_Actuator_3_Flow_Rate_Sensor_Ideal_Hydraulic_Flow_Rate;
  t0[9ULL] = Hydraulic_Actuator_3_Flow_Rate_Sensor_Ideal_Hydraulic_Flow_Rate *
    0.0010396380728769656;
  t0[10ULL] = Hydraulic_Actuator_3_Flow_Rate_Sensor_Ideal_Hydraulic_Flow_Rate *
    0.0010396380728769656;
  t0[11ULL] = Hydraulic_Actuator_3_Flow_Rate_Sensor_Ideal_Hydraulic_Flow_Rate *
    0.0010396380728769656;
  t0[12ULL] = X_idx_0 * 99999.999999999985;
  t0[13ULL] = X_idx_1 * 99999.999999999985;
  t0[14ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[15ULL] = X_idx_0 * 99999.999999999985;
  t0[16ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[17ULL] = X_idx_0 * 99999.999999999985;
  t0[18ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  ...
  t0[27ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[28ULL] = X_idx_1 * 99999.999999999985;
  t0[29ULL] = X_idx_1 * 500.0;
  t0[30ULL] = X_idx_3;
  t0[31ULL] = X_idx_13 * 1.0E-6;
  t0[32ULL] = X_idx_17;
  t0[33ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[34ULL] = X_idx_18;
  ...
  t0[69ULL] = U_idx_0;
  t0[70ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[71ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[72ULL] = X_idx_14;
  t0[73ULL] = X_idx_14 * 0.002;
  t0[74ULL] = X_idx_14 * X_idx_14 * 0.002;
  t0[75ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[76ULL] = X_idx_7;
  t0[77ULL] = Hydraulic_Actuator_3_Position_Sensor_Ideal_Translational_Motion;
  t0[78ULL] = X_idx_7;
  t0[79ULL] = X_idx_7;
  t0[80ULL] = Hydraulic_Actuator_3_Position_Sensor_Ideal_Translational_Motion;
  t0[81ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[82ULL] = (-X_idx_19 + -X_idx_20) * 1.0E-6;
  t0[83ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[84ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[85ULL] = X_idx_23;
  t0[86ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[87ULL] = X_idx_23;
  t0[88ULL] = X_idx_23;
  t0[89ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[90ULL] = Hydraulic_Actuator_3_Spring_Loaded_Accumulator_A_p *
    99999.999999999985;
  t0[91ULL] = X_idx_15 * 1.0E-6;
  t0[92ULL] = Hydraulic_Actuator_3_Spring_Loaded_Accumulator_A_p *
    99999.999999999985;
  t0[93ULL] = X_idx_8;
  ...
  t0[102ULL] = Hydraulic_Actuator_3_Spring_Loaded_Accumulator_A_p *
    99999.999999999985;
  ...
  t0[110ULL] = U_idx_1;
  t0[111ULL] = Hydraulic_Actuator_3_Spring_Loaded_Accumulator_A_p *
    99999.999999999985;
  t0[112ULL] = X_idx_0 * 99999.999999999985;
  t0[113ULL] = -(U_idx_1 + -24.0);
  t0[114ULL] = Hydraulic_Actuator_3_Spring_Loaded_Accumulator_A_p *
    99999.999999999985;
  ...
  t0[131ULL] = Hydraulic_Actuator_3_Flow_Rate_Sensor_Ideal_Hydraulic_Flow_Rate *
    -0.0010396380728769656;
  t0[132ULL] = -X_idx_1 * 99999.999999999985;
  t0[133ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[134ULL] = Prismatic_Joint2_fi;
  t0[135ULL] = U_idx_3;
  t0[136ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[137ULL] = Prismatic_Joint2_fi;
  t0[138ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[139ULL] = Prismatic_Joint2_fi;
  t0[140ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[141ULL] = Prismatic_Joint2_fi;
  t0[142ULL] = Hydraulic_Actuator_3_Hydraulic_Cylinder_R_v;
  t0[143ULL] = U_idx_3;
  t0[144ULL] = Prismatic_Joint2_fi;
  t0[145ULL] = U_idx_3;
  t0[146ULL] = U_idx_3;
  for (b = 0; b < 147; b++) {
    out.mX[b] = t0[b];
