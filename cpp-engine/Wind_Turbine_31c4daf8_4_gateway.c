...
#include "nesl_rtw.h"
#include "Wind_Turbine_31c4daf8_4.h"
#include "Wind_Turbine_31c4daf8_4_gateway.h"

void Wind_Turbine_31c4daf8_4_gateway(void)
{
  ...
  Wind_Turbine_31c4daf8_4_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Wind_Turbine/Solver Configuration_4",
    1,
    &dae,
    &solverparams,
    &modelparams,
