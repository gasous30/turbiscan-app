...
static NeEquationData s_equation_data[25] = { { "", 0U, 8,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 2U, 0U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 2U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 2U, 3U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 5U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 2U, 6U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    2U, 8U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    2U, 10U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    2U, 12U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 2U, 14U, TRUE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 16U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 17U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 18U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 19U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 5U, 20U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 35U,
    FALSE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 36U, FALSE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    37U, FALSE, 1.0, "1", }, { "", 0U, 1, NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Hydraulic/Actuator_1", 4U, 38U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME,
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 42U, TRUE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[25] = { {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.pressure_chamber",
    0U, 0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Fluid pressure in the chamber",
  }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.pressure_chamber",
    0U, 0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Fluid pressure in the chamber",
  }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.position",
    0U, 0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Piston position", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.position",
    0U, 0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Piston position", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.x", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0, TRUE,
    FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Position", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i1.x",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1.0, "1", 0.0, TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "x", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i2.x",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1.0, "1", 0.0, TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "x", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor.x",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    1.0, "1", 0.0, TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Position", }, {
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.fluid_volume", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1.0, "1", 0.0,
    TRUE, FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Volume of fluid", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.A.p", 0U, 1,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.q", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Flow rate", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.A.p", 0U, 1,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.q", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Flow rate", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.q", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Flow rate leaving the converter", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.f", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Force", }, {
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.flow_rate", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Accumulator flow rate", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.volume", 0U,
    0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Chamber volume", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.volume", 0U,
    0, "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Chamber volume", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.f", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Force", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.flow_rate",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Volumetric flow rate", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.flow_rate",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Volumetric flow rate", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i1.I",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "I", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i2.I",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "I", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor.F", 0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force/Ideal Force Sensor", 1.0, "1",
    0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "F", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice.pressure_drop",
    0U, 0,
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
...
static NeObservableData s_observable_data[196] = { {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure differential", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_A.q",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 1U, "m^3/s", 1.0e-6,
    "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure differential", }, {
    "Hydraulic.Actuator_1.Fixed_Orifice_B.q",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 1U, "m^3/s", 1.0e-6,
    "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.Ideal_Hydraulic_Flow_Rate_Sensor.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor/Ideal Hydraulic Flow Rate Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.Ideal_Hydraulic_Flow_Rate_Sensor.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor/Ideal Hydraulic Flow Rate Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.Ideal_Hydraulic_Flow_Rate_Sensor.M",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor/Ideal Hydraulic Flow Rate Sensor",
    1U, 1U, "kg/s", 1.0e-6, "kg/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "M", }, {
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.Ideal_Hydraulic_Flow_Rate_Sensor.Q",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate Sensor/Ideal Hydraulic Flow Rate Sensor",
    ...
    "Hydraulic.Actuator_1.Flow_Rate_Sensor.Ideal_Hydraulic_Flow_Rate_Sensor_Q",
    "Wind_Turbine/Hydraulic/Actuator_1/Flow Rate\nSensor/PS-Simulink\nConverter",
    1U, 1U, "m^3/s", 1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Hydraulic_Flow_Rate_Sensor_Q", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.pressure_chamber",
    ...
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.f",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "N", 1.0e-6,
    ...
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    ...
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.q",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m^3/s",
    ...
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.volume",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m^3",
    1.0e-6, "m^3", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Chamber volume", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "p", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.pressure_chamber",
    ...
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Fluid pressure in the chamber", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.f",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "N", 1.0e-6,
    "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Force exerted by the fluid on the converter", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "p", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.position",
    ...
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Piston position", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.q",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m^3/s",
    1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate leaving the converter", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.volume",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m^3",
    1.0e-6, "m^3", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Chamber volume", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "p", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.f",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "N", 1.0e-6,
    "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "p", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs.x",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Position", }, {
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.p_in",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U, "m", 1.0e-6,
    "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "p", }, {
    "Hydraulic.Actuator_1.Hydraulic_Fluid.G.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Fluid", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Hydraulic_Reference.P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Reference", 1U, 1U, "Pa",
    1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.T.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T.flow_rate",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m^3/s", 1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T.pressure_drop",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T.flow_rate",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m^3/s", 1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T.pressure_drop",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.flow_rate",
    ...
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A.pressure_drop",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.flow_rate",
    ...
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B.pressure_drop",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Port_A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Port_B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Port_P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Port_S",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional", 1U, 1U, "1", 1.0e-6,
    "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Port_S", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Port_T.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.I",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    ...
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i1.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i1.x",
    ...
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i2.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.i2.x",
    ...
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY,
    FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "x", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.sat_el.I",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.sat_el.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Ideal_Proportional_Port_S",
    "Wind_Turbine/Hydraulic/Actuator_1/Simulink-PS\nConverter", 1U, 1U, "1",
    1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Ideal_Proportional_Port_S", }, {
    "Hydraulic.Actuator_1.Mechanical_Translational_Reference1.V.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Mechanical Translational Reference1", 1U,
    1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.PAL.v", "Wind_Turbine/Hydraulic/Actuator_1", 1U, 1U,
    "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.f",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 1U, "N",
    1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Damper.power_dissipated",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 1U,
    "kg*m^2/s^3", 1.0e-6, "kg*m^2/s^3", NE_NOMINAL_SOURCE_NONE,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE,
    "power_dissipated", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor.P",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "P", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor.V",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Ideal Translational Motion Sensor",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    ...
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor_P",
    "Wind_Turbine/Hydraulic/Actuator_1/Position\nSensor/PS-Simulink\nConverter",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Translational_Motion_Sensor_P", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Ideal_Translational_Motion_Sensor_V",
    "Wind_Turbine/Hydraulic/Actuator_1/Position\nSensor/PS-Simulink\nConverter1",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Translational_Motion_Sensor_V", }, {
    "Hydraulic.Actuator_1.Position_Sensor.Mechanical_Translational_Reference2.V.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Mechanical Translational Reference2",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Position_Sensor.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor", 1U, 1U, "m/s", 1.0e-6,
    "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Pressure_Source.P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Pressure Source", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Pressure_Source.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Pressure Source", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Pressure_Source.T.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Pressure Source", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Pressure_Source.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Pressure Source", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure differential", }, {
    "Hydraulic.Actuator_1.Pressure_Source.q",
    "Wind_Turbine/Hydraulic/Actuator_1/Pressure Source", 1U, 1U, "m^3/s", 1.0e-6,
    "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate", }, {
    "Hydraulic.Actuator_1.Sense_Force.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force", 1U, 1U, "m/s", 1.0e-6,
    "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor.C.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force/Ideal Force Sensor", 1U, 1U,
    "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor.F",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force/Ideal Force Sensor", 1U, 1U,
    "N", 1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "F", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force/Ideal Force Sensor", 1U, 1U,
    "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor.f",
    ...
    "N", 1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor_F",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense\nForce/PS-Simulink\nConverter", 1U,
    1U, "N", 1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Ideal_Force_Sensor_F", }, {
    "Hydraulic.Actuator_1.Sense_Force.R.v",
    "Wind_Turbine/Hydraulic/Actuator_1/Sense Force", 1U, 1U, "m/s", 1.0e-6,
    "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 1U, "Pa",
    1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.flow_rate",
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 1U,
    ...
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.fluid_pressure",
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 1U, "Pa",
    1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure of liquid volume", }, {
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator.fluid_volume",
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 1U, "m^3",
    1.0e-6, "m^3", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volume of fluid", }, {
    "Hydraulic.Actuator_1.Subsystem.H.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem", 1U, 1U, "Pa", 1.0e-6, "bar",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem.Hydraulic_Reference1.P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem/Hydraulic Reference1", 1U, 1U,
    "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem.Ideal_Hydraulic_Pressure_Sensor.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem.Ideal_Hydraulic_Pressure_Sensor.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem.Ideal_Hydraulic_Pressure_Sensor.P",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "P", }, {
    "Hydraulic.Actuator_1.Subsystem.Ideal_Hydraulic_Pressure_Sensor_P",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem/PS-Simulink\nConverter1", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Hydraulic_Pressure_Sensor_P", }, {
    "Hydraulic.Actuator_1.Subsystem1.H.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1", 1U, 1U, "Pa", 1.0e-6, "bar",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem1.Hydraulic_Reference1.P.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1/Hydraulic Reference1", 1U, 1U,
    "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem1.Ideal_Hydraulic_Pressure_Sensor.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem1.Ideal_Hydraulic_Pressure_Sensor.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Subsystem1.Ideal_Hydraulic_Pressure_Sensor.P",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1/Ideal Hydraulic Pressure Sensor",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "P", }, {
    "Hydraulic.Actuator_1.Subsystem1.Ideal_Hydraulic_Pressure_Sensor_P",
    "Wind_Turbine/Hydraulic/Actuator_1/Subsystem1/PS-Simulink\nConverter1", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Hydraulic_Pressure_Sensor_P", }, {
    "Hydraulic.Actuator_1.System_Pressure.O",
    "Wind_Turbine/Hydraulic/Actuator_1/System Pressure", 1U, 1U, "1", 1.0e-6,
    "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.PS_Gain.I",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/PS Gain",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.PS_Gain.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/PS Gain",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.PS_Subtract.I1",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.PS_Subtract.I2",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I2", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.PS_Subtract.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.VA",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "VA", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open.Voltage_Open.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/Logic For Nominally Open/Voltage_Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.Logic_For_Nominally_Open_S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve\nAccumulator/Simulink-PS\nConverter",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Logic_For_Nominally_Open_S", },
    { "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice.flow_rate",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 1U, "m^3/s", 1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    ...
    1U, 1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.Actuator_1.Valve_Return.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return", 1U, 1U, "Pa", 1.0e-6,
    "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.PS_Gain.I",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/PS Gain",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.PS_Gain.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/PS Gain",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.PS_Subtract.I1",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I1", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.PS_Subtract.I2",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I2", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.PS_Subtract.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/PS Subtract",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.VA",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "VA", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open.Voltage_Open.O",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/Logic For Nominally Open/Voltage_Open",
    1U, 1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "O", }, {
    "Hydraulic.Actuator_1.Valve_Return.Logic_For_Nominally_Open_S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve\nReturn/Simulink-PS\nConverter", 1U,
    1U, "1", 1.0e-6, "1", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Logic_For_Nominally_Open_S", },
    { "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice.A.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice.B.p",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice.S",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "m", 1.0e-6, "m", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice.flow_rate",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "m^3/s", 1.0e-6, "cm^3/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Volumetric flow rate", },
    {
    "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice.pressure_drop",
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    1U, "Pa", 1.0e-6, "bar", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure drop", }, {
    "Hydraulic.PAL1.v", "Wind_Turbine/Hydraulic", 1U, 1U, "m/s", 1.0e-6, "m/s",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Mechanical_Translational_Reference.V.v",
    "Wind_Turbine/Mechanical Translational Reference", 1U, 1U, "m/s", 1.0e-6,
    "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, { "Prismatic_Joint_fi",
    "Wind_Turbine/Prismatic  Joint", 1U, 1U, "N", 1.0e-6, "N",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Prismatic_Joint_fi", }, {
    "Prismatic_Joint_v", "Wind_Turbine/Prismatic  Joint", 1U, 1U, "m/s", 1.0e-6,
    "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Prismatic_Joint_v", }, {
    "Translational_Simscape_Intf.C.v",
    "Wind_Turbine/Translational Simscape Intf", 1U, 1U, "m/s", 1.0e-6, "m/s",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.F", "Wind_Turbine/Translational Simscape Intf",
    1U, 1U, "N", 1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "F", }, {
    "Translational_Simscape_Intf.Ideal_Force_Sensor.C.v",
    "Wind_Turbine/Translational Simscape Intf/Ideal Force Sensor", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.Ideal_Force_Sensor.F",
    "Wind_Turbine/Translational Simscape Intf/Ideal Force Sensor", 1U, 1U, "N",
    1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "F", }, {
    "Translational_Simscape_Intf.Ideal_Force_Sensor.R.v",
    "Wind_Turbine/Translational Simscape Intf/Ideal Force Sensor", 1U, 1U, "m/s",
    1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.Ideal_Force_Sensor.f",
    ...
    1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Translational_Simscape_Intf.Ideal_Translational_Velocity_Source.C.v",
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.Ideal_Translational_Velocity_Source.R.v",
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.Ideal_Translational_Velocity_Source.S",
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Translational_Simscape_Intf.Ideal_Translational_Velocity_Source.f",
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 1U, "N", 1.0e-6, "N", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Translational_Simscape_Intf.Ideal_Translational_Velocity_Source.v",
    "Wind_Turbine/Translational Simscape Intf/Ideal Translational Velocity Source",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.R.v",
    "Wind_Turbine/Translational Simscape Intf", 1U, 1U, "m/s", 1.0e-6, "m/s",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Translational_Simscape_Intf.V", "Wind_Turbine/Translational Simscape Intf",
    1U, 1U, "m/s", 1.0e-6, "m/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", } };

static NeModeData *s_major_mode_data = NULL;
static NeZCData s_zc_data[29] = { {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 0U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter",
    ...
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 1U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 2U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 3U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 4U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+cylinders/translational_hardstop.sscp",
    NE_ZC_TYPE_TRUE, }, { "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder",
    1U, 5U, "Hydraulic.Actuator_1.Hydraulic_Cylinder.hs",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+cylinders/translational_hardstop.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 6U,
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_A_T",
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 9U,
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_B_T",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 10U,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 12U,
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 13U,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 15U,
    "Hydraulic.Actuator_1.Ideal_Proportional.Parameterized_Orifices.orifice_P_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    1U, 16U,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 18U,
    "Hydraulic.Actuator_1.Valve_Accumulator.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Accumulator/2-Way Directional Valve",
    1U, 19U,
    ...
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    21U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    22U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    23U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Proportional and Servo-Valve Actuator",
    1U, 24U,
    "Hydraulic.Actuator_1.Ideal_Proportional.Proportional_and_Servo_Valve_Actuator.sat_el",
    ...
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/physical_signal_legacy/+foundation/+physical_signal/+nonlinear/saturation.ssc",
    NE_ZC_TYPE_TRUE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 26U,
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+accumulators/accumulator_spr.sscp",
    NE_ZC_TYPE_TRUE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 27U,
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+accumulators/accumulator_spr.sscp",
    NE_ZC_TYPE_TRUE, }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 28U,
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+accumulators/accumulator_spr.sscp",
    NE_ZC_TYPE_FALSE, } };
...
static NeAssertData s_assert_data[108] = { {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 3U, 0U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter",
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 3U, 3U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+cylinders/cylinder_da.sscp",
    FALSE, "Fluid pressure in the chamber must be greater than -1 atm.",
    "physmod:simscape:compiler:patterns:checks:GreaterThan", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 6U,
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+accumulators/accumulator_spr.sscp",
    FALSE, "Fluid pressure fell below absolute zero", "", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", 1U, 7U,
    "Hydraulic.Actuator_1.Spring_Loaded_Accumulator",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+accumulators/accumulator_spr.sscp",
    TRUE, "Fluid pressure fell below absolute zero", "", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 8U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 9U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 10U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    ...
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 11U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 12U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 13U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 14U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 15U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 16U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 17U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 18U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 19U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 20U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_A.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 21U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 22U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 23U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 24U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 25U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 26U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 27U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 28U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 29U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.drho_over_rho0dp",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 30U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 31U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 32U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Hydraulic Cylinder", 1U, 33U,
    "Hydraulic.Actuator_1.Hydraulic_Cylinder.conv_B.chosen_converter.rho_over_rho0",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/translational_converter_compressible.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 34U,
    "Hydraulic.Actuator_1.Position_Sensor.Damper.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/damper.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Position Sensor/Damper", 1U, 35U,
    "Hydraulic.Actuator_1.Position_Sensor.Damper.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/damper.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    ...
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    52U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    53U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    54U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    55U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Ideal Proportional/Parameterized Orifices",
    ...
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 60U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 61U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 62U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 63U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 64U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 65U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 66U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 67U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 68U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 69U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    ...
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    105U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    106U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    107U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    108U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    109U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    110U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Valve Return/2-Way Directional Valve", 1U,
    111U, "Hydraulic.Actuator_1.Valve_Return.x2_Way_Directional_Valve.orifice",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", } };
...
static NeAssertData s_param_assert_data[10] = { {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 0U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "Orifice area must be greater than zero.",
    "physmod:simscape:compiler:patterns:checks:GreaterThanZero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 1U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "Orifice area must be greater than zero.",
    "physmod:simscape:compiler:patterns:checks:GreaterThanZero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 2U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 3U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 4U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 5U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 6U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", 1U, 7U,
    "Hydraulic.Actuator_1.Fixed_Orifice_A",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 8U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", 1U, 9U,
    "Hydraulic.Actuator_1.Fixed_Orifice_B",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+hydraulic/+elements/constant_area_orifice.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
...
static NeParameterData s_real_parameter_data[3] = { { "RTP_2D820D23_area",
    "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice A", "", 0U, 1U, TRUE, }, {
    "RTP_BD3D10B2_area", "Wind_Turbine/Hydraulic/Actuator_1/Fixed Orifice B", "",
    0U, 1U, TRUE, }, { "RTP_E521AE59_fluid_volume",
    "Wind_Turbine/Hydraulic/Actuator_1/Spring-Loaded Accumulator", "", 0U, 1U,
    TRUE, } };
...
NeDynamicSystem *Wind_Turbine_31c4daf8_5_dae_ds(PmAllocator *allocator)
{
  ...
  input_info[0].mIdentifier = "Hydraulic.Actuator_1.Ideal_Proportional_Port_S";
  input_info[0].mM = 1;
  input_info[0].mN = 1;
  input_info[0].mName = "Hydraulic.Actuator_1.Ideal_Proportional_Port_S";
  ...
  input_info[3].mIdentifier = "Prismatic_Joint_v";
  input_info[3].mM = 1;
  input_info[3].mN = 1;
  input_info[3].mName = "Prismatic_Joint_v";
  ...
  output_info[3].mM = 1;
  output_info[3].mN = 1;
  output_info[3].mName = "Hydraulic.Actuator_1.Sense_Force.Ideal_Force_Sensor_F";
  ...
  output_info[6].mIdentifier = "Prismatic_Joint_fi";
  output_info[6].mM = 1;
  output_info[6].mN = 1;
  output_info[6].mName = "Prismatic_Joint_fi";
