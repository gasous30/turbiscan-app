...
#include "nesl_rtw.h"
#include "Wind_Turbine_31c4daf8_8.h"
#include "Wind_Turbine_31c4daf8_8_gateway.h"

void Wind_Turbine_31c4daf8_8_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0, 0.001, 0, 0,
    0, 0, (SscLoggingSetting) 1, 566501190, 0, };
  ...
  Wind_Turbine_31c4daf8_8_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Wind_Turbine/Solver Configuration_8",
    1,
    &dae,
    &solverparams,
    &modelparams,
