...
const NeZCData *Wind_Turbine_31c4daf8_1_ZCData = NULL;
PmfMessageId Wind_Turbine_31c4daf8_1_computeAsmModeVector(const double *input,
...
PmfMessageId Wind_Turbine_31c4daf8_1_computeSimModeVector(const double *input,
  const double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId Wind_Turbine_31c4daf8_1_computeZeroCrossings(const
