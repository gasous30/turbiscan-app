...
int32_T Wind_Turbine_31c4daf8_4_ds_dxf(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t127, NeDsMethodOutput *t128)
{
  PmRealVector out;
  real_T t3[27];
  real_T t6[5];
  ...
  int32_T M_idx_8;
  int32_T M_idx_9;
  M_idx_0 = t127->mM.mX[0];
  M_idx_1 = t127->mM.mX[1];
  M_idx_2 = t127->mM.mX[2];
  M_idx_3 = t127->mM.mX[3];
  M_idx_4 = t127->mM.mX[4];
  M_idx_5 = t127->mM.mX[5];
  M_idx_6 = t127->mM.mX[6];
  M_idx_7 = t127->mM.mX[7];
  M_idx_8 = t127->mM.mX[8];
  M_idx_9 = t127->mM.mX[9];
  M_idx_10 = t127->mM.mX[10];
  M_idx_11 = t127->mM.mX[11];
  M_idx_12 = t127->mM.mX[12];
  M_idx_13 = t127->mM.mX[13];
  M_idx_14 = t127->mM.mX[14];
  M_idx_15 = t127->mM.mX[15];
  M_idx_16 = t127->mM.mX[16];
  M_idx_17 = t127->mM.mX[17];
  M_idx_18 = t127->mM.mX[18];
  M_idx_22 = t127->mM.mX[22];
  U_idx_1 = t127->mU.mX[1];
  U_idx_2 = t127->mU.mX[2];
  X_idx_0 = t127->mX.mX[0];
  X_idx_1 = t127->mX.mX[1];
  X_idx_6 = t127->mX.mX[6];
  X_idx_8 = t127->mX.mX[8];
  X_idx_9 = t127->mX.mX[9];
  X_idx_11 = t127->mX.mX[11];
  X_idx_14 = t127->mX.mX[14];
  X_idx_15 = t127->mX.mX[15];
  X_idx_24 = t127->mX.mX[24];
  DP_R_idx_0 = t127->mDP_R.mX[0];
  DP_R_idx_1 = t127->mDP_R.mX[1];
  DP_R_idx_2 = t127->mDP_R.mX[2];
  DP_R_idx_3 = t127->mDP_R.mX[3];
  out = t128->mDXF;
  t29 = -X_idx_0 + X_idx_9;
  t125 = -X_idx_1 + X_idx_11;
  t126 = X_idx_14 * 0.002;
  t45 = pmf_pow(1.01325 / (X_idx_0 + 1.01325 == 0.0 ? 1.0E-16 : X_idx_0 +
  ...
  t62 = -(-(t36 * 1.0E+6) / 4975.0312972714573);
  t36 = pmf_sqrt(t29 * t29 + DP_R_idx_2 * DP_R_idx_2) * pmf_sqrt(pmf_sqrt(t29 *
  ...
  t64 = -(-(t40 * 1.0E+6) / 4975.0312972714573);
  t40 = pmf_sqrt(t125 * t125 + DP_R_idx_3 * DP_R_idx_3) * pmf_sqrt(pmf_sqrt(t125
  ...
  t6[4ULL] = t126;
  t3[0ULL] = t62;
  t3[1ULL] = -((-(t67 / (t68 == 0.0 ? 1.0E-16 : t68) * (1.0 / (t36 == 0.0 ?
    1.0E-16 : t36)) * t29) * 0.5 + -DP_R_idx_0 * 0.031919356375394323 / (t70 ==
    0.0 ? 1.0E-16 : t70)) * 3.1622776601683795E+8);
  t3[2ULL] = t64;
  t3[3ULL] = -((-(t71 / (t73 == 0.0 ? 1.0E-16 : t73) * (1.0 / (t40 == 0.0 ?
    1.0E-16 : t40)) * t125) * 0.5 + -DP_R_idx_1 * 0.031919356375394323 / (t75 ==
  ...
  t3[14ULL] = -((t67 / (t68 == 0.0 ? 1.0E-16 : t68) * (1.0 / (t36 == 0.0 ?
    1.0E-16 : t36)) * t29 * 0.5 + DP_R_idx_0 * 0.031919356375394323 / (t70 ==
    0.0 ? 1.0E-16 : t70)) * 3.1622776601683795E+8);
  ...
  t36 = pmf_sqrt(pmf_sqrt(X_idx_24 * X_idx_24 + t48 * t48));
  out.mX[0] = t3[0];
  out.mX[1] = t3[1];
  out.mX[2] = t3[2];
  out.mX[3] = t3[3];
  ...
  out.mX[17] = -((t71 / (t73 == 0.0 ? 1.0E-16 : t73) * (1.0 / (t40 == 0.0 ?
    1.0E-16 : t40)) * t125 * 0.5 + DP_R_idx_1 * 0.031919356375394323 / (t75 ==
    0.0 ? 1.0E-16 : t75)) * 3.1622776601683795E+8);
  ...
  out.mX[20] = -(-(1.0000062909088354 / (t45 == 0.0 ? 1.0E-16 : t45) * 0.002 *
  ...
  out.mX[26] = -((-(X_idx_24 * zc_int14 * 0.031919356375394323) / (t126 == 0.0 ?
    1.0E-16 : t126) * (1.0 / (t29 == 0.0 ? 1.0E-16 : t29)) * X_idx_24 * 0.5 +
                  zc_int14 * 0.031919356375394323 / (t36 == 0.0 ? 1.0E-16 : t36))
                 * 3.1622776601683795E+8);
  (void)sys;
  (void)t128;
  return 0;
