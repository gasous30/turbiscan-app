...
#include "nesl_rtw.h"
#include "Wind_Turbine_31c4daf8_7.h"
#include "Wind_Turbine_31c4daf8_7_gateway.h"

void Wind_Turbine_31c4daf8_7_gateway(void)
{
  ...
  Wind_Turbine_31c4daf8_7_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Wind_Turbine/Solver Configuration_7",
    1,
    &dae,
    &solverparams,
    &modelparams,
