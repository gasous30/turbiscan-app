...
int32_T Wind_Turbine_31c4daf8_3_ds_assert(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t9, NeDsMethodOutput *t10)
{
  PmIntVector out;
  real_T DP_R_idx_2;
  real_T DP_R_idx_3;
  real_T Hydraulic_Actuator_3_Fixed_Orifice_A_p;
  real_T Hydraulic_Actuator_3_Fixed_Orifice_B_p;
  real_T U_idx_1;
  real_T U_idx_2;
  real_T X_idx_0;
  real_T X_idx_1;
  ...
  out = t10->mASSERT;
  Hydraulic_Actuator_3_Fixed_Orifice_A_p = -X_idx_0 + X_idx_9;
  Hydraulic_Actuator_3_Fixed_Orifice_B_p = -X_idx_1 + X_idx_11;
  if (X_idx_6 > 0.003) {
  ...
  t0[57ULL] = 1;
  t0[58ULL] = 1;
  t0[59ULL] = (int32_T)(Hydraulic_Actuator_3_Fixed_Orifice_A_p *
                        Hydraulic_Actuator_3_Fixed_Orifice_A_p + DP_R_idx_2 *
                        DP_R_idx_2 >= 0.0);
  t0[60ULL] = (int32_T)((!(Hydraulic_Actuator_3_Fixed_Orifice_A_p *
    Hydraulic_Actuator_3_Fixed_Orifice_A_p + DP_R_idx_2 * DP_R_idx_2 >= 0.0)) ||
                        (pmf_sqrt(pmf_sqrt
    (Hydraulic_Actuator_3_Fixed_Orifice_A_p *
     Hydraulic_Actuator_3_Fixed_Orifice_A_p + DP_R_idx_2 * DP_R_idx_2)) != 0.0));
  t0[61ULL] = 1;
  t0[62ULL] = 1;
  t0[63ULL] = 1;
  t0[64ULL] = (int32_T)(Hydraulic_Actuator_3_Fixed_Orifice_B_p *
                        Hydraulic_Actuator_3_Fixed_Orifice_B_p + DP_R_idx_3 *
                        DP_R_idx_3 >= 0.0);
  t0[65ULL] = (int32_T)((!(Hydraulic_Actuator_3_Fixed_Orifice_B_p *
    Hydraulic_Actuator_3_Fixed_Orifice_B_p + DP_R_idx_3 * DP_R_idx_3 >= 0.0)) ||
                        (pmf_sqrt(pmf_sqrt
    (Hydraulic_Actuator_3_Fixed_Orifice_B_p *
     Hydraulic_Actuator_3_Fixed_Orifice_B_p + DP_R_idx_3 * DP_R_idx_3)) != 0.0));
  t0[66ULL] = 1;
  t0[67ULL] = 1;
  t0[68ULL] = 1;
