...
int32_T Wind_Turbine_31c4daf8_5_ds_dxf(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t129, NeDsMethodOutput *t130)
{
  ...
  t29 = pmf_sqrt(X_idx_24 * X_idx_24 + t48 * t48) * pmf_sqrt(pmf_sqrt(X_idx_24 *
    X_idx_24 + t48 * t48));
  t35 = pmf_sqrt(pmf_sqrt(X_idx_24 * X_idx_24 + t48 * t48)) * pmf_sqrt(pmf_sqrt
  ...
  out.mX[24] = 1.0;
  out.mX[25] = 0.05;
  out.mX[26] = -((-(X_idx_24 * zc_int14 * 0.031919356375394323) / (t35 == 0.0 ?
    1.0E-16 : t35) * (1.0 / (t29 == 0.0 ? 1.0E-16 : t29)) * X_idx_24 * 0.5 +
