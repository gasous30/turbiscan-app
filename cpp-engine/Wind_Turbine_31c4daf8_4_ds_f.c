  ...
  NeDynamicSystemInput *t32, NeDsMethodOutput *t33)
{
  ...
  X_idx_14 = pmf_pow(1.01325 / (X_idx_0 + 1.01325 == 0.0 ? 1.0E-16 : X_idx_0 +
    ...
    12428.460456240617);
  t12 = t31 * (1.0000062909088354 / (X_idx_14 == 0.0 ? 1.0E-16 : X_idx_14)) *
    -0.005;
  ...
  t12 = pmf_sqrt(pmf_sqrt(t30 * t30 + DP_R_idx_3 * DP_R_idx_3));
  X_idx_8 = -(DP_R_idx_1 * t30 * 0.031919356375394323 / (t12 == 0.0 ? 1.0E-16 :
    t12) * 3.1622776601683795E+8);
