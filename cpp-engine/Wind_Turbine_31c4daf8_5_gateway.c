...
#include "nesl_rtw.h"
#include "Wind_Turbine_31c4daf8_5.h"
#include "Wind_Turbine_31c4daf8_5_gateway.h"

void Wind_Turbine_31c4daf8_5_gateway(void)
{
  ...
  Wind_Turbine_31c4daf8_5_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Wind_Turbine/Solver Configuration_5",
    1,
    &dae,
    &solverparams,
    &modelparams,
