...
{
  PmRealVector out;
  real_T Hydraulic_Actuator_2_Ideal_Proportional_Proportional_and_Servo_;
  real_T U_idx_0;
  real_T U_idx_1;
  real_T U_idx_2;
  real_T X_idx_0;
  ...
  out = t16->mZC;
  Hydraulic_Actuator_2_Ideal_Proportional_Proportional_and_Servo_ = -X_idx_6 +
    U_idx_0;
  if (X_idx_6 > 0.003) {
    intrm_sf_mf_9 = 0.005;
  ...
  if (M_idx_8 == 0) {
    X_idx_6 = -0.3 -
      Hydraulic_Actuator_2_Ideal_Proportional_Proportional_and_Servo_;
  } else {
    X_idx_6 = 0.0;
  }
  ...
  out.mX[24] = Hydraulic_Actuator_2_Ideal_Proportional_Proportional_and_Servo_ -
    0.3;
  out.mX[25] = X_idx_6;
